...
physician_files <- list(
  ...
  # 放射線科医抽出用: 都道府県×診療科(複数回答)医療施設従事医師数。隔年(2014-2024)で系列統一。
  #   放射線科の列は年で異なる(2014/16/18/22/24=col37, 2020=col40)ため10_prepareはヘッダ検出。
  #   表番号も年で異なる(2014/16=第43表, 2018/20=閲覧第24表, 2022=第25表, 2024=第26表)。
  list(year = 2014, id = "000031336086", table = "T43",
       label = "医療施設従事医師数(都道府県・診療科 複数回答)"),
  list(year = 2016, id = "000031653235", table = "T43",
       label = "医療施設従事医師数(都道府県・診療科 複数回答)"),
  list(year = 2018, id = "000031889174", table = "T24",
       label = "医療施設従事医師数(都道府県・診療科 複数回答)"),
  list(year = 2020, id = "000032179800", table = "T24",
       label = "医療施設従事医師数(都道府県・診療科 複数回答)"),
